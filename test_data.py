...
import make_tfrecord


# 1.获取训练数据集
def get_data(batch_size, data_name=None, record_path=None, repeat=1, re_size=64, classes=10):
    if data_name == 'cifar10':
        ...
        return make_tfrecord.get_tfrecord_data(img_shape=(128, 128, 3), re_size=re_size,
